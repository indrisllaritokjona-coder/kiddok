...
function DiaryComponent_For_15_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 39);
    \u0275\u0275listener("click", function DiaryComponent_For_15_Template_button_click_0_listener() {
...
function DiaryComponent_For_27_Template(rf, ctx) {
  if (rf & 1) {
...
function DiaryComponent_For_30_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "span", 42);
  }
}
function DiaryComponent_For_30_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "span", 43);
  }
}
function DiaryComponent_For_30_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 39);
    \u0275\u0275listener("click", function DiaryComponent_For_30_Template_button_click_0_listener() {
    ...
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(3, DiaryComponent_For_30_Conditional_3_Template, 1, 0, "span", 42);
    \u0275\u0275conditionalCreate(4, DiaryComponent_For_30_Conditional_4_Template, 1, 0, "span", 43);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function DiaryComponent_Conditional_45_Template(rf, ctx) {
  if (rf & 1) {
...
function DiaryComponent_For_47_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "span");
  }
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275classMap(\u0275\u0275interpolate1("w-3 h-3 rounded-full ", ctx_r2.severityColor(entry_r10.severity)));
  }
}
function DiaryComponent_For_47_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const entry_r10 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", entry_r10.duration, " ");
  }
}
function DiaryComponent_For_47_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const entry_r10 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(entry_r10.notes);
  }
}
function DiaryComponent_For_47_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 29)(1, "div", 46)(2, "div", 47);
    \u0275\u0275element(3, "lucide-icon", 48);
    \u0275\u0275elementStart(4, "span");
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(6, DiaryComponent_For_47_Conditional_6_Template, 1, 3, "span", 7);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "button", 49);
    \u0275\u0275listener("click", function DiaryComponent_For_47_Template_button_click_7_listener() {
      const entry_r10 = \u0275\u0275restoreView(_r9).$implicit;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.deleteEntry(entry_r10));
    });
    \u0275\u0275element(8, "lucide-icon", 50);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "p", 51);
    \u0275\u0275text(10);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(11, DiaryComponent_For_47_Conditional_11_Template, 3, 1, "p", 52);
    \u0275\u0275conditionalCreate(12, DiaryComponent_For_47_Conditional_12_Template, 2, 1, "p", 53);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275classMap(\u0275\u0275interpolate1("text-base ", ctx_r2.typeIconClass(entry_r10.type)));
    \u0275\u0275property("name", ctx_r2.typeIcon(entry_r10.type));
    \u0275\u0275advance();
    \u0275\u0275classMap(\u0275\u0275interpolate1("text-xs font-bold uppercase tracking-wider ", ctx_r2.typeColorClass(entry_r10.type)));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r2.typeLabel(entry_r10.type), " ");
    \u0275\u0275advance();
    \u0275\u0275conditional(entry_r10.severity ? 6 : -1);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(entry_r10.description);
    \u0275\u0275advance();
    \u0275\u0275conditional(entry_r10.type === "symptom" && entry_r10.duration ? 11 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(entry_r10.notes ? 12 : -1);
  }
}
function DiaryComponent_Conditional_57_Template(rf, ctx) {
  if (rf & 1) {
...
function DiaryComponent_For_60_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "span");
  }
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275classMap(\u0275\u0275interpolate1("w-2.5 h-2.5 rounded-full ", ctx_r2.severityColor(entry_r11.severity)));
  }
}
function DiaryComponent_For_60_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const entry_r11 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(entry_r11.duration);
  }
}
function DiaryComponent_For_60_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 37)(1, "div", 55)(2, "span", 56);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(4, DiaryComponent_For_60_Conditional_4_Template, 1, 3, "span", 7);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "div", 57)(6, "div", 58)(7, "span");
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(12);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(13, DiaryComponent_For_60_Conditional_13_Template, 2, 1, "p", 59);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r2.typeEmoji(entry_r11.type));
    \u0275\u0275advance();
    \u0275\u0275conditional(entry_r11.severity ? 4 : -1);
    \u0275\u0275advance(3);
    \u0275\u0275classMap(\u0275\u0275interpolate1("text-xs font-bold uppercase tracking-wider ", ctx_r2.typeColorClass(entry_r11.type)));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r2.typeLabel(entry_r11.type));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r2.formatEntryTime(entry_r11.loggedAt));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(entry_r11.description);
    \u0275\u0275advance();
    \u0275\u0275conditional(entry_r11.duration ? 13 : -1);
  }
}
function DiaryComponent_Conditional_61_For_12_Template(rf, ctx) {
  if (rf & 1) {
    const _r13 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 39);
    \u0275\u0275listener("click", function DiaryComponent_Conditional_61_For_12_Template_button_click_0_listener() {
      const type_r14 = \u0275\u0275restoreView(_r13).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.newEntryType.set(type_r14.value));
    });
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275classMap(\u0275\u0275interpolate1("flex-1 py-2.5 rounded-xl text-xs font-bold uppercase tracking-wider transition-all border-2 flex flex-col items-center gap-1\n                             ", ctx_r2.newEntryType() === type_r14.value ? "bg-primary-600 text-white border-primary-600" : "bg-slate-50 text-slate-500 border-transparent hover:bg-slate-100"));
    \u0275\u0275advance();
    \u0275\u0275property("name", type_r14.icon);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(type_r14.label());
  }
}
function DiaryComponent_Conditional_61_Conditional_18_For_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r16 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 39);
    \u0275\u0275listener("click", function DiaryComponent_Conditional_61_Conditional_18_For_5_Template_button_click_0_listener() {
      const symptom_r17 = \u0275\u0275restoreView(_r16).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r2.toggleSymptom(symptom_r17.key));
    });
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext(3);
    \u0275\u0275classMap(\u0275\u0275interpolate1("px-4 py-2 rounded-full text-sm font-semibold border-2 transition-all\n                                   ", ctx_r2.newSymptoms().includes(symptom_r17.key) ? "bg-orange-500 text-white border-orange-500" : "bg-white text-slate-500 border-slate-200 hover:border-orange-300"));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", symptom_r17.label(), " ");
  }
}
function DiaryComponent_Conditional_61_Conditional_18_For_11_Template(rf, ctx) {
  if (rf & 1) {
    const _r18 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 39);
    \u0275\u0275listener("click", function DiaryComponent_Conditional_61_Conditional_18_For_11_Template_button_click_0_listener() {
      const sev_r19 = \u0275\u0275restoreView(_r18).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r2.newSeverity.set(sev_r19.value));
    });
    \u0275\u0275element(1, "span");
  ...
  if (rf & 2) {
    const sev_r19 = ctx.$implicit;
    const ctx_r2 = \u0275\u0275nextContext(3);
    \u0275\u0275classMap(\u0275\u0275interpolate1("flex flex-col items-center gap-1.5 px-4 py-3 rounded-xl border-2 transition-all ", ctx_r2.newSeverity() === sev_r19.value ? sev_r19.activeClass : "bg-slate-50 border-slate-200 hover:" + sev_r19.hoverClass));
    \u0275\u0275advance();
    \u0275\u0275classMap(\u0275\u0275interpolate1("w-5 h-5 rounded-full ", sev_r19.dotClass));
    \u0275\u0275advance();
    \u0275\u0275classMap(\u0275\u0275interpolate1("text-xs font-bold ", ctx_r2.newSeverity() === sev_r19.value ? sev_r19.textClass : "text-slate-500"));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(sev_r19.label());
  }
}
function DiaryComponent_Conditional_61_Conditional_18_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(4, DiaryComponent_Conditional_61_Conditional_18_For_5_Template, 2, 4, "button", 7, _forTrack4);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "div")(7, "label", 75);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(14);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "input", 78);
    \u0275\u0275twoWayListener("ngModelChange", function DiaryComponent_Conditional_61_Conditional_18_Template_input_ngModelChange_15_listener($event) {
      \u0275\u0275restoreView(_r15);
      const ctx_r2 = \u0275\u0275nextContext(2);
...
function DiaryComponent_Conditional_61_Template(rf, ctx) {
  if (rf & 1) {
    const _r12 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 61);
    \u0275\u0275listener("click", function DiaryComponent_Conditional_61_Template_div_click_0_listener() {
      \u0275\u0275restoreView(_r12);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.closeModal());
    });
    \u0275\u0275elementStart(1, "div", 62);
    \u0275\u0275listener("click", function DiaryComponent_Conditional_61_Template_div_click_1_listener($event) {
      return $event.stopPropagation();
    });
    \u0275\u0275elementStart(2, "div", 63)(3, "div")(4, "h3", 64);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function DiaryComponent_Conditional_61_Template_button_click_8_listener() {
      \u0275\u0275restoreView(_r12);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.closeModal());
    });
    ...
    \u0275\u0275text(16);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "textarea", 70);
    \u0275\u0275twoWayListener("ngModelChange", function DiaryComponent_Conditional_61_Template_textarea_ngModelChange_17_listener($event) {
      \u0275\u0275restoreView(_r12);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(18, DiaryComponent_Conditional_61_Conditional_18_Template, 16, 5);
    \u0275\u0275elementStart(19, "div")(20, "label", 69);
    \u0275\u0275text(21);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(22, "textarea", 70);
    \u0275\u0275twoWayListener("ngModelChange", function DiaryComponent_Conditional_61_Template_textarea_ngModelChange_22_listener($event) {
      \u0275\u0275restoreView(_r12);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function DiaryComponent_Conditional_61_Template_button_click_24_listener() {
      \u0275\u0275restoreView(_r12);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.closeModal());
    });
    ...
    \u0275\u0275listener("click", function DiaryComponent_Conditional_61_Template_button_click_26_listener() {
      \u0275\u0275restoreView(_r12);
      const ctx_r2 = \u0275\u0275nextContext();
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DiaryComponent, selectors: [["app-diary"]], decls: 62, vars: 14, consts: [[1, "px-2", "max-w-7xl", "mx-auto"], [1, "flex", "items-center", "justify-between", "mb-6", "flex-col", "sm:flex-row", "gap-4"], [1, "text-3xl", "font-extrabold", "text-gray-800"], [1, "text-slate-400", "text-sm", "mt-1", "font-medium"], [1, "bg-gradient-to-r", "from-primary-600", "to-primary-500", "hover:from-primary-500", "hover:to-primary-400", "text-white", "px-6", "py-3", "rounded-2xl", "font-bold", "shadow-md", "hover:shadow-lg", "transition-all", "flex", "items-center", "gap-2", "text-sm", 3, "click"], ["name", "plus", 1, "text-inherit"], [1, "flex", "items-center", "justify-center", "gap-3", "mb-6", "flex-wrap"], [3, "class"], [1, "flex", "items-center", "gap-2", "mb-6", "flex-wrap"], [1, "grid", "grid-cols-1", "lg:grid-cols-3", "gap-6"], [1, "lg:col-span-2", "bg-white", "rounded-[2rem]", "shadow-soft", "border", "border-slate-100", "overflow-hidden"], [1, "flex", "items-center", "justify-between", "p-5", "border-b", "border-slate-100"], [1, "w-10", "h-10", "rounded-xl", "bg-slate-100", "hover:bg-slate-200", "flex", "items-center", "justify-center", "transition-colors", 3, "click"], ["name", "chevron-left", 1, "text-inherit"], [1, "text-lg", "font-extrabold", "text-gray-800", "tracking-wide"], ["name", "chevron-right", 1, "text-inherit"], [1, "grid", "grid-cols-7", "border-b", "border-slate-100"], [1, "py-3", "text-center", "text-xs", "font-bold", "text-slate-400", "uppercase", "tracking-wider"], [1, "grid", "grid-cols-7", "p-3", "gap-1"], [1, "flex", "items-center", "gap-6", "px-5", "py-4", "border-t", "border-slate-100", "bg-slate-50/50"], [1, "flex", "items-center", "gap-2", "text-xs", "text-slate-400", "font-medium"], [1, "w-2", "h-2", "rounded-full", "bg-teal-400", "inline-block"], [1, "w-2", "h-2", "rounded-full", "bg-primary-500", "inline-block"], [1, "bg-white", "rounded-[2rem]", "shadow-soft", "border", "border-slate-100", "overflow-hidden"], [1, "p-5", "border-b", "border-slate-100"], [1, "font-extrabold", "text-gray-800", "text-lg"], [1, "text-slate-400", "text-xs", "mt-1", "font-medium"], [1, "p-4", "space-y-3", "max-h-[500px]", "overflow-y-auto"], [1, "text-center", "py-10"], [1, "rounded-2xl", "border", "border-slate-100", "p-4", "bg-slate-50/60", "hover:bg-slate-100/80", "transition-colors", "group"], [1, "mt-8", "bg-white", "rounded-[2rem]", "shadow-soft", "border", "border-slate-100", "overflow-hidden"], [1, "p-5", "border-b", "border-slate-100", "flex", "items-center", "justify-between"], [1, "text-slate-400", "text-xs", "mt-0.5", "font-medium"], ["name", "history", 1, "text-inherit"], [1, "p-5"], [1, "text-center", "py-8"], [1, "space-y-3"], [1, "flex", "items-start", "gap-3", "p-3", "rounded-xl", "hover:bg-slate-50", "transition-colors"], [1, "fixed", "inset-0", "z-50", "flex", "items-center", "justify-center", "p-4", "bg-black/30", "backdrop-blur-sm"], [3, "click"], [1, "text-2xl"], [1, "text-xs", "font-semibold", "text-slate-600", "leading-tight", "text-center", "px-1"], [1, "absolute", "bottom-1.5", "w-1.5", "h-1.5", "rounded-full", "bg-teal-400"], [1, "absolute", "bottom-1.5", "w-1.5", "h-1.5", "rounded-full", "bg-primary-500"], ["name", "inbox", 1, "text-inherit"], [1, "text-slate-400", "text-sm", "font-medium"], [1, "flex", "items-start", "justify-between", "mb-2"], [1, "flex", "items-center", "gap-2"], [3, "name"], [1, "opacity-0", "group-hover:opacity-100", "text-red-400", "hover:text-red-600", "transition-all", 3, "click"], ["name", "trash-2", 1, "text-inherit"], [1, "text-sm", "font-semibold", "text-gray-800", "mb-1"], [1, "text-xs", "text-slate-500", "font-medium", "mb-1"], [1, "text-xs", "text-slate-500", "italic", "mt-2", "border-t", "border-slate-200", "pt-2"], ["name", "clock", 1, "text-inherit"], [1, "flex", "flex-col", "items-center", "gap-1", "min-w-[40px]"], [1, "text-xl"], [1, "flex-1", "min-w-0"], [1, "flex", "items-center", "gap-2", "flex-wrap"], [1, "text-xs", "text-slate-400", "font-medium"], [1, "text-sm", "text-gray-800", "font-medium", "truncate"], [1, "fixed", "inset-0", "z-50", "flex", "items-center", "justify-center", "p-4", "bg-black/30", "backdrop-blur-sm", 3, "click"], [1, "bg-white", "rounded-[2rem]", "shadow-2xl", "w-full", "max-w-lg", "max-h-[90vh]", "overflow-y-auto", "animate-slide-up", 3, "click"], [1, "flex", "items-center", "justify-between", "p-6", "border-b", "border-slate-100"], [1, "text-xl", "font-extrabold", "text-gray-800"], [1, "w-9", "h-9", "rounded-xl", "bg-slate-100", "hover:bg-slate-200", "flex", "items-center", "justify-center", "transition-colors", 3, "click"], ["name", "x", 1, "text-inherit"], [1, "flex", "p-4", "gap-2", "border-b", "border-slate-100"], [1, "p-6", "space-y-5"], [1, "block", "text-xs", "font-bold", "text-primary-700", "mb-2", "uppercase", "tracking-wider"], ["rows", "2", 1, "w-full", "px-4", "py-3", "rounded-2xl", "border-2", "border-slate-200", "bg-slate-50", "focus:bg-white", "focus:ring-4", "focus:ring-primary-500/10", "focus:border-primary-500", "outline-none", "transition-all", "text-gray-800", "text-sm", "resize-none", 3, "ngModelChange", "ngModel", "placeholder"], [1, "flex", "gap-3", "pt-2"], [1, "flex-1", "py-3.5", "rounded-2xl", "bg-slate-100", "text-slate-600", "font-bold", "text-sm", "hover:bg-slate-200", "transition-colors", 3, "click"], [1, "flex-1", "py-3.5", "rounded-2xl", "bg-gradient-to-r", "from-primary-600", "to-primary-500", "text-white", "font-bold", "text-sm", "shadow-md", "hover:shadow-lg", "disabled:opacity-40", "disabled:cursor-not-allowed", "transition-all", 3, "click", "disabled"], [1, "text-sm", 3, "name"], [1, "block", "text-xs", "font-bold", "text-primary-700", "mb-3", "uppercase", "tracking-wider"], [1, "flex", "flex-wrap", "gap-2"], [1, "flex", "gap-3"], ["type", "text", 1, "w-full", "px-4", "py-3", "rounded-2xl", "border-2", "border-slate-200", "bg-slate-50", "focus:bg-white", "focus:ring-4", "focus:ring-primary-500/10", "focus:border-primary-500", "outline-none", "transition-all", "text-gray-800", "text-sm", 3, "ngModelChange", "ngModel", "placeholder"]], template: function DiaryComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(21, "h2", 14);
        \u0275\u0275text(22);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(23, "button", 12);
        \u0275\u0275listener("click", function DiaryComponent_Template_button_click_23_listener() {
          return ctx.nextMonth();
        });
        \u0275\u0275element(24, "lucide-icon", 15);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(25, "div", 16);
        \u0275\u0275repeaterCreate(26, DiaryComponent_For_27_Template, 2, 1, "div", 17, \u0275\u0275repeaterTrackByIdentity);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(28, "div", 18);
        \u0275\u0275repeaterCreate(29, DiaryComponent_For_30_Template, 5, 6, "button", 7, _forTrack2);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(31, "div", 19)(32, "div", 20);
        \u0275\u0275element(33, "span", 21);
        \u0275\u0275text(34);
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275text(37);
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(38, "div", 23)(39, "div", 24)(40, "h3", 25);
        \u0275\u0275text(41);
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275conditionalCreate(45, DiaryComponent_Conditional_45_Template, 4, 1, "div", 28);
        \u0275\u0275repeaterCreate(46, DiaryComponent_For_47_Template, 13, 12, "div", 29, _forTrack3);
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(48, "div", 30)(49, "div", 31)(50, "div")(51, "h3", 25);
        \u0275\u0275text(52);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(53, "p", 32);
        \u0275\u0275text(54);
        \u0275\u0275elementEnd()();
        \u0275\u0275element(55, "lucide-icon", 33);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(56, "div", 34);
        \u0275\u0275conditionalCreate(57, DiaryComponent_Conditional_57_Template, 4, 1, "div", 35);
        \u0275\u0275elementStart(58, "div", 36);
        \u0275\u0275repeaterCreate(59, DiaryComponent_For_60_Template, 14, 9, "div", 37, _forTrack3);
        \u0275\u0275elementEnd()()()();
        \u0275\u0275conditionalCreate(61, DiaryComponent_Conditional_61_Template, 28, 12, "div", 38);
      }
      if (rf & 2) {
        \u0275\u0275advance(4);
        ...
        \u0275\u0275advance(2);
        \u0275\u0275conditional(ctx.filteredEntriesForDate().length === 0 ? 45 : -1);
        \u0275\u0275advance();
        ...
        \u0275\u0275advance(3);
        \u0275\u0275conditional(ctx.recentEntries().length === 0 ? 57 : -1);
        \u0275\u0275advance(2);
        \u0275\u0275repeater(ctx.recentEntries());
        \u0275\u0275advance(2);
        \u0275\u0275conditional(ctx.showModal() ? 61 : -1);
      }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DiaryComponent, { className: "DiaryComponent", filePath: "src/app/components/diary.component.ts", lineNumber: 331 });
})();
export {
  DiaryComponent
};
//# sourceMappingURL=chunk-A3DXW2GR.js.map
