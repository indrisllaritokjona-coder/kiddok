...
function TemperatureDiaryComponent_Conditional_6_For_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 45);
  }
}
function TemperatureDiaryComponent_Conditional_6_For_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 46);
    \u0275\u0275element(1, "div", 47)(2, "div", 48);
    \u0275\u0275elementEnd();
  }
}
function TemperatureDiaryComponent_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 5)(1, "div", 39)(2, "div", 40);
    \u0275\u0275element(3, "div", 41)(4, "div", 42);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "div", 43);
    \u0275\u0275element(6, "div", 44);
    \u0275\u0275elementStart(7, "div", 12);
    \u0275\u0275repeaterCreate(8, TemperatureDiaryComponent_Conditional_6_For_9_Template, 1, 0, "div", 45, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(10, "div", 43);
    \u0275\u0275repeaterCreate(11, TemperatureDiaryComponent_Conditional_6_For_12_Template, 3, 0, "div", 46, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    \u0275\u0275advance(8);
...
function TemperatureDiaryComponent_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 6)(1, "div", 49);
    \u0275\u0275element(2, "lucide-icon", 50);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 51)(4, "p", 52);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
...
function TemperatureDiaryComponent_Conditional_12_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "span", 57);
  }
}
function TemperatureDiaryComponent_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(4, "\xB0C");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(5, TemperatureDiaryComponent_Conditional_12_Conditional_5_Template, 1, 0, "span", 57);
    \u0275\u0275elementStart(6, "button", 58);
    \u0275\u0275element(7, "lucide-icon", 59);
    \u0275\u0275elementEnd()();
...
function TemperatureDiaryComponent_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
...
function TemperatureDiaryComponent_For_19_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 65);
    \u0275\u0275listener("click", function TemperatureDiaryComponent_For_19_Template_button_click_0_listener() {
...
function TemperatureDiaryComponent_Conditional_33_Template(rf, ctx) {
  if (rf & 1) {
...
function TemperatureDiaryComponent_For_43_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 66);
    \u0275\u0275listener("click", function TemperatureDiaryComponent_For_43_Template_button_click_0_listener() {
...
function TemperatureDiaryComponent_Conditional_48_Template(rf, ctx) {
  if (rf & 1) {
...
function TemperatureDiaryComponent_Conditional_52_Template(rf, ctx) {
  if (rf & 1) {
...
function TemperatureDiaryComponent_Conditional_66_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function TemperatureDiaryComponent_Conditional_66_Template_button_click_5_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.formTemp.set(null));
    });
    \u0275\u0275element(6, "lucide-icon", 74);
    \u0275\u0275text(7);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275textInterpolate(ctx_r1.i18n.t()["temperature.noReadings"]);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", ctx_r1.i18n.t()["temperature.addFirst"], " ");
  }
}
function TemperatureDiaryComponent_Conditional_67_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 51)(5, "p", 78);
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function TemperatureDiaryComponent_Conditional_67_For_2_Template_button_click_9_listener() {
      const entry_r9 = \u0275\u0275restoreView(_r8).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.deleteEntry(entry_r9.id));
    });
    \u0275\u0275element(10, "lucide-icon", 81);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275property("ngClass", ctx_r1.tempDotClass(entry_r9.temperature));
    \u0275\u0275advance();
    \u0275\u0275property("ngClass", ctx_r1.tempTextClass(entry_r9.temperature));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", entry_r9.temperature, "\xB0 ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r1.formatTime(entry_r9.measuredAt));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate2("", ctx_r1.formatDate(entry_r9.measuredAt), " \u2022 ", ctx_r1.locationLabel(entry_r9.location));
  }
}
function TemperatureDiaryComponent_Conditional_67_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 38);
    \u0275\u0275repeaterCreate(1, TemperatureDiaryComponent_Conditional_67_For_2_Template, 11, 6, "div", 75, _forTrack1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
  ...
  ngOnInit() {
    return __async(this, null, function* () {
      ...
      if (childId) {
        ...
        try {
          yield this.dataService.loadTemperatureEntries(childId);
        } finally {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TemperatureDiaryComponent, selectors: [["app-temperature-diary"]], viewQuery: function TemperatureDiaryComponent_Query(rf, ctx) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd()();
        \u0275\u0275conditionalCreate(6, TemperatureDiaryComponent_Conditional_6_Template, 13, 2, "div", 5);
        \u0275\u0275conditionalCreate(7, TemperatureDiaryComponent_Conditional_7_Template, 8, 2, "div", 6);
        \u0275\u0275elementStart(8, "div", 7)(9, "div", 8)(10, "p", 9);
        \u0275\u0275text(11);
        \u0275\u0275elementEnd();
        \u0275\u0275conditionalCreate(12, TemperatureDiaryComponent_Conditional_12_Template, 10, 6)(13, TemperatureDiaryComponent_Conditional_13_Template, 7, 1);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(14, "div", 10)(15, "p", 11);
        \u0275\u0275text(16);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(17, "div", 12);
        \u0275\u0275repeaterCreate(18, TemperatureDiaryComponent_For_19_Template, 2, 2, "button", 13, \u0275\u0275repeaterTrackByIdentity);
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(20, "div", 7)(21, "div", 14)(22, "h3", 15);
        \u0275\u0275element(23, "lucide-icon", 16);
        \u0275\u0275text(24);
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275twoWayListener("ngModelChange", function TemperatureDiaryComponent_Template_input_ngModelChange_30_listener($event) {
          \u0275\u0275restoreView(_r1);
        ...
        \u0275\u0275text(32, "\xB0C");
        \u0275\u0275elementEnd()();
        \u0275\u0275conditionalCreate(33, TemperatureDiaryComponent_Conditional_33_Template, 2, 0, "p", 22);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(34, "div")(35, "label", 18);
        \u0275\u0275text(36);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(37, "input", 23);
        \u0275\u0275twoWayListener("ngModelChange", function TemperatureDiaryComponent_Template_input_ngModelChange_37_listener($event) {
          \u0275\u0275restoreView(_r1);
          \u0275\u0275twoWayBindingSet(ctx.formTime, $event) || (ctx.formTime = $event);
          return \u0275\u0275resetView($event);
        });
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(38, "div")(39, "label", 18);
        \u0275\u0275text(40);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(41, "div", 24);
        \u0275\u0275repeaterCreate(42, TemperatureDiaryComponent_For_43_Template, 2, 4, "button", 25, _forTrack0);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(44, "div")(45, "label", 18);
        \u0275\u0275text(46);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(47, "textarea", 26);
        \u0275\u0275twoWayListener("ngModelChange", function TemperatureDiaryComponent_Template_textarea_ngModelChange_47_listener($event) {
          \u0275\u0275restoreView(_r1);
          \u0275\u0275twoWayBindingSet(ctx.formNotes, $event) || (ctx.formNotes = $event);
          return \u0275\u0275resetView($event);
        });
        \u0275\u0275elementEnd()();
        \u0275\u0275conditionalCreate(48, TemperatureDiaryComponent_Conditional_48_Template, 2, 1, "div", 27);
        \u0275\u0275elementStart(49, "button", 28);
        \u0275\u0275listener("click", function TemperatureDiaryComponent_Template_button_click_49_listener() {
          return ctx.saveReading();
        });
        \u0275\u0275conditionalCreate(50, TemperatureDiaryComponent_Conditional_50_Template, 2, 1)(51, TemperatureDiaryComponent_Conditional_51_Template, 2, 1)(52, TemperatureDiaryComponent_Conditional_52_Template, 2, 1);
        \u0275\u0275elementEnd()()()();
        \u0275\u0275elementStart(53, "div", 7)(54, "div", 14)(55, "h3", 29);
        \u0275\u0275element(56, "lucide-icon", 30);
        \u0275\u0275text(57);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(58, "div", 31);
        \u0275\u0275element(59, "canvas", 32, 0);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(61, "div", 33)(62, "div", 34)(63, "h3", 35);
        \u0275\u0275element(64, "lucide-icon", 36);
        \u0275\u0275text(65);
        \u0275\u0275elementEnd()();
        \u0275\u0275conditionalCreate(66, TemperatureDiaryComponent_Conditional_66_Template, 8, 2, "div", 37)(67, TemperatureDiaryComponent_Conditional_67_Template, 3, 0, "div", 38);
        \u0275\u0275elementEnd()();
      }
      if (rf & 2) {
        \u0275\u0275advance(4);
        ...
        \u0275\u0275advance();
        \u0275\u0275conditional(ctx.latestEntry() && ctx.latestEntry().temperature > 38.5 ? 7 : -1);
        \u0275\u0275advance(4);
        \u0275\u0275textInterpolate(ctx.i18n.t()["temperature.current"]);
        \u0275\u0275advance();
        \u0275\u0275conditional(ctx.latestEntry() ? 12 : 13);
        \u0275\u0275advance(4);
        ...
        \u0275\u0275advance(3);
        \u0275\u0275conditional(ctx.formTemp() !== null && (ctx.formTemp() < 35 || ctx.formTemp() > 42) ? 33 : -1);
        \u0275\u0275advance(3);
        ...
        \u0275\u0275advance();
        \u0275\u0275conditional(ctx.saveError() ? 48 : -1);
        \u0275\u0275advance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TemperatureDiaryComponent, { className: "TemperatureDiaryComponent", filePath: "src/app/components/temperature-diary.component.ts", lineNumber: 282 });
})();
export {
  TemperatureDiaryComponent
};
//# sourceMappingURL=chunk-AJQKSCAV.js.map
