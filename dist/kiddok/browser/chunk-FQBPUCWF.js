...
var translations = {
  ...
  "appointments.upcomingCount": { sq: "{n} termn i ardhsh\xEBm", en: "{n} upcoming appointment" },
  "appointments.upcomingCountPlural": { sq: "{n} terme t\xEB ardhshme", en: "{n} upcoming appointments" },
...
var DataService = class _DataService {
  ...
  cacheTemperaturesToOffline(entries) {
    return __async(this, null, function* () {
      try {
        const { OfflineService: OfflineService2 } = yield import("./chunk-IVCG2LQY.js");
  ...
  cacheToOffline() {
    return __async(this, null, function* () {
      try {
        const offlineService = new (yield import("./chunk-IVCG2LQY.js")).OfflineService();
...
var OfflineService = class _OfflineService {
  getSyncServiceAsync() {
    return __async(this, null, function* () {
      ...
      if (injector) {
        const { SyncService } = yield import("./chunk-6COXSPIE.js");
...
//# sourceMappingURL=chunk-FQBPUCWF.js.map
