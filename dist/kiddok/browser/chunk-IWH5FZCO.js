...
var DataService = class _DataService {
  ...
  cacheTemperaturesToOffline(entries) {
    return __async(this, null, function* () {
      try {
        const { OfflineService: OfflineService2 } = yield import("./chunk-O3ZUP6BS.js");
  ...
  cacheToOffline() {
    return __async(this, null, function* () {
      try {
        const offlineService = new (yield import("./chunk-O3ZUP6BS.js")).OfflineService();
...
var OfflineService = class _OfflineService {
  getSyncServiceAsync() {
    return __async(this, null, function* () {
      ...
      if (injector) {
        const { SyncService } = yield import("./chunk-SUPVJEUK.js");
...
//# sourceMappingURL=chunk-IWH5FZCO.js.map
