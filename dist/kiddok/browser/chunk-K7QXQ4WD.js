...
var DataService = class _DataService {
  ...
  cacheTemperaturesToOffline(entries) {
    return __async(this, null, function* () {
      try {
        const { OfflineService: OfflineService2 } = yield import("./chunk-YUKE5BRS.js");
  ...
  cacheToOffline() {
    return __async(this, null, function* () {
      try {
        const offlineService = new (yield import("./chunk-YUKE5BRS.js")).OfflineService();
...
var OfflineService = class _OfflineService {
  getSyncServiceAsync() {
    return __async(this, null, function* () {
      ...
      if (injector) {
        const { SyncService } = yield import("./chunk-YQU62YFP.js");
...
//# sourceMappingURL=chunk-K7QXQ4WD.js.map
