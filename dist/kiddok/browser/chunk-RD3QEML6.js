...
var ToastService = class _ToastService {
  ...
  show(message, type = "info", duration) {
    const d = duration ?? (type === "success" ? 3e3 : type === "error" ? 5e3 : 3e3);
  ...
  resolveKey(key, params) {
    ...
    const translations2 = {
      "error.api.generic": { sq: "Ndodhi nj\xEB gabim, provoni p\xEBrs\xEBri", en: "Something went wrong, please try again" },
      "error.api.loadChildren": { sq: "Ngarkimi i f\xEBmij\xEBve d\xEBshtoi", en: "Failed to load children" },
      "error.api.loadTemperature": { sq: "Ngarkimi i temperaturave d\xEBshtoi", en: "Failed to load temperature entries" },
      "error.api.createTemperature": { sq: "Ruajtja e temperatur\xEBs d\xEBshtoi", en: "Failed to save temperature" },
      "error.api.loadGrowth": { sq: "Ngarkimi i rritjes d\xEBshtoi", en: "Failed to load growth entries" },
      "error.api.createGrowth": { sq: "Ruajtja e rritjes d\xEBshtoi", en: "Failed to save growth entry" },
      "error.api.deleteGrowth": { sq: "Fshirja e rritjes d\xEBshtoi", en: "Failed to delete growth entry" },
      "error.api.loadVaccines": { sq: "Ngarkimi i vaksinave d\xEBshtoi", en: "Failed to load vaccine records" },
      "error.api.createVaccine": { sq: "Ruajtja e vaksinave d\xEBshtoi", en: "Failed to save vaccine" },
      "error.api.deleteVaccine": { sq: "Fshirja e vaksinave d\xEBshtoi", en: "Failed to delete vaccine" },
      "error.api.createChild": { sq: "Krijimi i profilit d\xEBshtoi", en: "Failed to create profile" },
      "error.api.updateChild": { sq: "P\xEBrdit\xEBsimi i profilit d\xEBshtoi", en: "Failed to update profile" },
      "error.api.deleteChild": { sq: "Fshirja e profilit d\xEBshtoi", en: "Failed to delete profile" },
      "error.api.fetchParent": { sq: "Ngarkimi i profilit d\xEBshtoi", en: "Failed to load profile" },
      "error.api.updateParent": { sq: "P\xEBrdit\xEBsimi i profilit d\xEBshtoi", en: "Failed to update profile" },
      "error.api.export": { sq: "Eksportimi d\xEBshtoi. Provoni p\xEBrs\xEBri.", en: "Export failed. Please try again." },
      "error.api.login": { sq: "Identifikimi d\xEBshtoi", en: "Login failed" },
      "success.saved": { sq: "U ruajt me sukses!", en: "Saved successfully!" },
      "success.deleted": { sq: "U fshi me sukses!", en: "Deleted successfully!" },
      "success.exported": { sq: "Eksportimi u p\xEBrfundua!", en: "Export complete!" },
      "offline.queued": { sq: "Ruajtur lokallisht \u2014 do t\xEB sinkronizohet kur t\xEB jeni online", en: "Saved locally \u2014 will sync when online" }
    };
    let text = translations2[key]?.[locale] || translations2[key]?.["sq"] || key;
    if (params) {
...
var translations = {
  ...
  "appointments.section.upcoming": { sq: "t\xEB ardhshme", en: "Upcoming" },
  "appointments.section.past": { sq: "T\xEB kaluara", en: "Past" },
  "appointments.overdueCount": { sq: "{n} termin i vonuar", en: "{n} appointment overdue" },
  "appointments.overdueCountPlural": { sq: "{n} termine t\xEB vonuara", en: "{n} appointments overdue" },
  "appointments.upcomingCount": { sq: "{n} termin i ardhsh\xEBm", en: "{n} upcoming appointment" },
  "appointments.upcomingCountPlural": { sq: "{n} termine t\xEB ardhshme", en: "{n} upcoming appointments" },
  ...
  "export.noDataInRange": { sq: "Nuk ka t\xEB dh\xEBna n\xEB periudh\xEBn e zgjedhur.", en: "No data in the selected range." },
  "export.largeRangeWarning": { sq: "Periudha e zgjedhur \xEBsht\xEB e gjer\xEB \u2014 eksportimi mund t\xEB zgjas\xEB.", en: "Selected range is large \u2014 export may take longer." },
  ...
  "labResults.typeUrinalysis": { sq: "Analiz\xEB Urine", en: "Urinalysis" },
  ...
  "labResults.typeOther": { sq: "Tjet\xEBr", en: "Other" },
  "labResults.attachments": { sq: "Dokumente", en: "Documents" },
  "labResults.dropZoneHint": { sq: "Zv\xEBre dokumentin ose kliko p\xEBr t\xEB zgjedhur", en: "Drop files here or click to select" },
  "labResults.remove": { sq: "Hiqe", en: "Remove" },
  "labResults.fileTooBig": { sq: "Skedari tejkalon 10MB", en: "File exceeds 10MB" },
  "labResults.fileTypeError": { sq: "Lloji i skedarit nuk mb\xEBshtetet. Vet\xEBm PDF dhe imazhe.", en: "File type not supported. PDF and images only." },
  "labResults.maxFilesReached": { sq: "Maksimumi 5 fajlla p\xEBr rezultat", en: "Maximum 5 files per result" },
  ...
  // ─── Offline / Sync (Sprint 7) ─────────────────────────────────
  "offline.banner": { sq: "Jeni offline", en: "You are offline" },
  "offline.bannerPending": { sq: "Duke pritur sinkronizim", en: "Pending sync" },
  "offline.syncing": { sq: "Duke sinkronizuar...", en: "Syncing..." },
  "offline.synced": { sq: "Sinkronizuar", en: "Synced" },
  "offline.syncError": { sq: "Gabim sinkronizimi", en: "Sync error" },
  "offline.conflict": { sq: "Konflikt", en: "Conflict" },
  "offline.retry": { sq: "Provo p\xEBrs\xEBri", en: "Retry" },
  "offline.pendingCount": { sq: "{n} n\xEB pritje", en: "{n} pending" },
  "sync.status.idle": { sq: "Gati", en: "Idle" },
  "sync.status.syncing": { sq: "Duke sinkronizuar", en: "Syncing" },
  "sync.status.synced": { sq: "Sinkronizuar", en: "Synced" },
  "sync.status.error": { sq: "Gabim", en: "Error" },
  "sync.status.conflict": { sq: "Konflikt", en: "Conflict" },
  "sync.conflict.resolveLocal": { sq: "P\xEBrdor Lokalen", en: "Use Local" },
  "sync.conflict.resolveServer": { sq: "P\xEBrdor Serverin", en: "Use Server" },
  "sync.conflict.medicalReview": { sq: "Rishikim Mjek\xEBsor", en: "Medical Review" },
  "sync.conflict.footer": { sq: "Konfliktet zgjidhen automatikisht p\xEBr t\xEB dh\xEBna jo-mjek\xEBsore.", en: "Non-medical data conflicts are resolved automatically." },
  "sync.conflict.panelTitle": { sq: "Konflikt i t\xEB Dh\xEBnave", en: "Data Conflict" },
  "sync.conflict.panelSubtitle": { sq: "T\xEB dh\xEBna q\xEB k\xEBrkojn\xEB rishikim manual", en: "Data requiring manual review" },
  "sync.conflict.local": { sq: "Lokalisht", en: "Local" },
  "sync.conflict.server": { sq: "Serveri", en: "Server" },
  "sync.lastSynced.justNow": { sq: "tani", en: "just now" },
  "sync.lastSynced.minsAgo": { sq: "{n} min m\xEB par\xEB", en: "{n}m ago" },
  "sync.lastSynced.hoursAgo": { sq: "{n} or\xEB m\xEB par\xEB", en: "{n}h ago" },
  "sync.queue.count": { sq: "{n} n\xEB radh\xEB", en: "{n} in queue" },
  "sync.online": { sq: "Jeni online! Duke sinkronizuar...", en: "You are online! Syncing..." },
  "sync.offline": { sq: "Jeni offline. T\xEB dh\xEBnat do t\xEB ruhen lokalisht.", en: "You are offline. Data will be saved locally." },
  "offline.queued": { sq: "Ruajtur lokalisht \u2014 do t\xEB sinkronizohet kur t\xEB jeni online", en: "Saved locally \u2014 will sync when online" },
  // ─── Error / Success Keys (Sprint 7) ──────────────────────────
  "error.api.generic": { sq: "Ndodhi nj\xEB gabim, provoni p\xEBrs\xEBri", en: "Something went wrong, please try again" },
  "error.api.loadChildren": { sq: "Ngarkimi i f\xEBmij\xEBve d\xEBshtoi", en: "Failed to load children" },
  "error.api.loadTemperature": { sq: "Ngarkimi i temperaturave d\xEBshtoi", en: "Failed to load temperature entries" },
  "error.api.createTemperature": { sq: "Ruajtja e temperatur\xEBs d\xEBshtoi", en: "Failed to save temperature" },
  ...
  "child.saveSuccess": { sq: "Ndryshimet u ruajt\xEBn!", en: "Changes saved!" },
  "child.saving": { sq: "Duke ruajtur...", en: "Saving..." },
  "child.deleteConfirmTitle": { sq: "Fshi profilin e f\xEBmij\xEBs?", en: "Delete child profile?" },
  "child.deleteConfirmBody": { sq: "Ky veprim nuk mund t\xEB kthehet. T\xEB gjitha t\xEB dh\xEBnat do t\xEB fshihen p\xEBrgjithmon\xEB.", en: "This action cannot be undone. All data will be permanently deleted." },
  "child.delete": { sq: "Fshi", en: "Delete" },
  "child.activeBadge": { sq: "Aktiv", en: "Active" },
  "validation.nameLettersOnly": { sq: "Emri mund t\xEB p\xEBrmbaj\xEB vet\xEBm shkronja.", en: "Name can only contain letters." },
  "nav.menu": { sq: "Meny", en: "Menu" },
  "sync.pending": { sq: "Duke pritur sinkronizim", en: "Pending sync" },
  "offline.onlineSyncing": { sq: "Jeni online! Duke sinkronizuar t\xEB dh\xEBnat...", en: "You're online! Syncing data..." },
  "offline.offline": { sq: "Jeni offline. T\xEB dh\xEBnat do t\xEB ruhen lokalisht.", en: "You're offline. Data will be saved locally." },
  "error.generic": { sq: "Ndodhi nj\xEB gabim, provoni p\xEBrs\xEBri.", en: "An error occurred, please try again." },
  "error.exportFailed": { sq: "Eksportimi d\xEBshtoi. Provoni p\xEBrs\xEBri.", en: "Export failed. Please try again." },
  "diary.addFirst": { sq: "Shto Sh\xEBnimin", en: "Add Entry" },
...
var DataService = class _DataService {
  constructor(http) {
    ...
    this.offline = inject(OfflineService);
  ...
  addDiaryEntry(entry) {
    return __async(this, null, function* () {
      if (!navigator.onLine) {
        yield this.offline.addToSyncQueue({
          action: "create",
          entity: "diary",
        ...
        const localEntry = __spreadProps(__spreadValues({}, entry), { id: "local_" + Date.now() });
  ...
  updateDiaryEntry(id, data) {
    return __async(this, null, function* () {
      ...
      const updatedEntry = existing ? __spreadValues(__spreadValues({}, existing), data) : null;
      if (updatedEntry) {
      ...
      if (!navigator.onLine) {
        ...
        if (existing)
          this.saveDiaryLocally(existing.childId, this.diaryEntries());
        this.toast.showKey("offline.queued");
        return updatedEntry;
      }
      try {
        ...
        if (existing)
          this.saveDiaryLocally(existing.childId, list);
        return updated;
      } catch (err) {
  ...
  createChild(data) {
    return __async(this, null, function* () {
      ...
      const localProfile = {
        ...
        bloodType: data.bloodType ?? void 0,
        birthWeight: data.birthWeight ?? void 0,
        deliveryDoctor: data.deliveryDoctor ?? void 0,
        criticalAllergies: data.criticalAllergies ?? void 0,
        avatarUrl: this.getAvatarUrl({ name: data.name ?? "", avatarSeed })
      };
      if (!navigator.onLine) {
        yield this.offline.addToSyncQueue({
          action: "create",
          entity: "diary",
          // children use a different entity, but SyncQueueEntry expects one of the 4 types
          endpoint: "/children",
          method: "POST",
          body: payload
        });
  ...
  updateChildApi(id, data) {
    return __async(this, null, function* () {
      ...
      const optimistic = existing ? __spreadValues(__spreadValues({}, existing), data) : null;
      if (optimistic) {
  ...
  cacheTemperaturesToOffline(entries) {
    return __async(this, null, function* () {
      try {
        yield this.offline.saveTemperaturesToOffline(entries);
      } catch (e) {
      }
    });
  }
  getOfflineTemperatures(childId) {
    return __async(this, null, function* () {
      try {
        return yield this.offline.getTemperaturesFromOffline(childId);
      } catch (e) {
        return [];
      }
    });
  ...
  createTemperatureEntry(data) {
    return __async(this, null, function* () {
      if (!navigator.onLine) {
        ...
        const localEntry = __spreadProps(__spreadValues({}, data), { id: "local_" + Date.now(), createdAt: (/* @__PURE__ */ new Date()).toISOString() });
  ...
  loadLabResults(childId) {
    return __async(this, null, function* () {
      try {
        const records = yield firstValueFrom(this.http.get(`${this.API_URL}/lab-results/child/${childId}`, this.getHeaders()));
  ...
  addLabResult(childId, data) {
    return __async(this, null, function* () {
      try {
        const record = yield firstValueFrom(this.http.post(`${this.API_URL}/lab-results/${childId}`, data, this.getHeaders()));
  ...
  updateLabResult(id, data) {
    return __async(this, null, function* () {
      try {
        const record = yield firstValueFrom(this.http.patch(`${this.API_URL}/lab-results/${id}`, data, this.getHeaders()));
  ...
  deleteLabResult(id) {
    return __async(this, null, function* () {
      try {
        yield firstValueFrom(this.http.delete(`${this.API_URL}/lab-results/${id}`, this.getHeaders()));
  ...
  getLabResult(id) {
    return __async(this, null, function* () {
      return firstValueFrom(this.http.get(`${this.API_URL}/lab-results/${id}`, this.getHeaders()));
    });
  }
  ...
  cacheGrowthToOffline(entries) {
    return __async(this, null, function* () {
      try {
        yield this.offline.saveGrowthToOffline(entries);
      } catch (e) {
      }
    });
  }
  getOfflineGrowth(childId) {
    return __async(this, null, function* () {
      try {
        return yield this.offline.getGrowthFromOffline(childId);
      } catch (e) {
        return [];
      }
    });
  ...
  cacheVaccinesToOffline(records) {
    return __async(this, null, function* () {
      try {
        yield this.offline.saveVaccinesToOffline(records);
      } catch (e) {
      }
    });
  }
  getOfflineVaccines(childId) {
    return __async(this, null, function* () {
      try {
        return yield this.offline.getVaccinesFromOffline(childId);
      } catch (e) {
        return [];
      }
    });
  }
  createVaccineRecord(data) {
    return __async(this, null, function* () {
      if (!navigator.onLine) {
        yield this.offline.addToSyncQueue({
          action: "create",
        ...
        const localEntry = __spreadProps(__spreadValues({}, data), { id: "local_" + Date.now() });
        this.vaccineRecords.update((current) => [localEntry, ...current]);
        this.toast.showKey("offline.queued");
        return localEntry;
      }
      try {
        const created = yield firstValueFrom(this.http.post(`${this.API_URL}/vaccines`, data, this.getHeaders()));
  ...
  updateVaccineRecord(id, data) {
    return __async(this, null, function* () {
      ...
      try {
        const updated = yield firstValueFrom(this.http.patch(`${this.API_URL}/vaccines/${id}`, data, this.getHeaders()));
  ...
  deleteVaccineRecord(id) {
    return __async(this, null, function* () {
      ...
      try {
        yield firstValueFrom(this.http.delete(`${this.API_URL}/vaccines/${id}`, this.getHeaders()));
      } catch (err) {
  ...
  createGrowthEntry(data) {
    return __async(this, null, function* () {
      if (!navigator.onLine) {
        ...
        const localEntry = __spreadProps(__spreadValues({}, data), { id: "local_" + Date.now(), createdAt: (/* @__PURE__ */ new Date()).toISOString(), height: data.height ?? null, weight: data.weight ?? null, notes: data.notes ?? null });
  ...
  cacheToOffline() {
    return __async(this, null, function* () {
      try {
        yield this.offline.saveChildrenToOffline(this.children());
        const activeId = this.activeChildId();
        if (activeId) {
          yield this.offline.saveTemperaturesToOffline(this.temperatureEntries());
          yield this.offline.saveGrowthToOffline(this.growthEntries());
          yield this.offline.saveVaccinesToOffline(this.vaccineRecords());
          yield this.offline.saveDiaryToOffline(this.diaryEntries());
        }
      } catch (e) {
      }
    });
  ...
  loadFromOffline() {
    return __async(this, null, function* () {
      try {
        const cachedChildren = yield this.offline.getChildrenFromOffline();
        if (cachedChildren.length > 0) {
          ...
          yield this.offline.loadCachedChildData(firstChild.id);
        }
      } catch (e) {
      }
    });
...
var OfflineService = class _OfflineService {
  ...
  saveParentToOffline(profile) {
    return __async(this, null, function* () {
      const db = yield this.getDb();
      const tx = db.transaction(STORE_PARENT, "readwrite");
      const store = tx.objectStore(STORE_PARENT);
      store.put(__spreadProps(__spreadValues({}, profile), { key: "profile" }));
      return new Promise((resolve, reject) => {
        tx.oncomplete = () => resolve();
        tx.onerror = () => reject(tx.error);
      });
  ...
  // ─── Update Operations ────────────────────────────────────────
  updateTemperatureToOffline(entry) {
    return __async(this, null, function* () {
      const db = yield this.getDb();
      const tx = db.transaction(STORE_TEMPERATURES, "readwrite");
      const store = tx.objectStore(STORE_TEMPERATURES);
