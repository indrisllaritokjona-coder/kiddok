  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SidebarComponent, selectors: [["app-sidebar"]], decls: 21, vars: 7, consts: [["aria-label", "Sidebar navigation", 1, "sidebar"], [1, "sidebar__brand"], [1, "sidebar__logo"], ["type", "button", 1, "locale-toggle", 3, "click"], [1, "sidebar__child-card"], [1, "sidebar__child-placeholder"], ["aria-label", "Main navigation", 1, "sidebar__nav"], ["type", "button", 1, "sidebar__nav-item", 3, "sidebar__nav-item--active"], [1, "sidebar__footer"], ["type", "button", 1, "sidebar__footer-item", 3, "click"], ["name", "settings", "aria-hidden", "true", 1, "sidebar__nav-icon"], ["type", "button", 1, "sidebar__footer-item", "sidebar__footer-item--logout", 3, "click"], ["name", "LogOut", "aria-hidden", "true", 1, "sidebar__nav-icon"], [1, "sidebar__avatar", 3, "src", "alt"], [1, "sidebar__child-info"], [1, "sidebar__child-name"], [1, "sidebar__age-badge"], ["name", "user", "aria-hidden", "true", 1, "sidebar__placeholder-icon"], [1, "sidebar__placeholder-text"], ["type", "button", 1, "sidebar__nav-item", 3, "click"], ["aria-hidden", "true", 1, "sidebar__nav-icon", 3, "name"]], template: function SidebarComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275repeaterCreate(10, SidebarComponent_For_11_Template, 4, 5, "button", 7, _forTrack0);
        \u0275\u0275elementEnd();
...
function HeaderComponent_Conditional_18_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(6, HeaderComponent_Conditional_18_For_7_Template, 8, 9, "div", 40, _forTrack02);
...
function HeaderComponent_Conditional_23_For_13_Conditional_9_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r1.i18n.isSq() ? "Aktiv" : "Active", " ");
  }
}
...
function HeaderComponent_Conditional_23_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(12, HeaderComponent_Conditional_23_For_13_Template, 10, 20, "button", 65, _forTrack02);
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BottomNavComponent, selectors: [["app-bottom-nav"]], decls: 4, vars: 0, consts: [["aria-label", "Main navigation", 1, "lg:hidden", "fixed", "bottom-0", "w-full", "bg-white", "dark:bg-slate-800", "border-t", "border-stone-200", "dark:border-slate-700", "z-50", "h-16", 2, "padding-bottom", "env(safe-area-inset-bottom)"], [1, "flex", "flex-row", "h-full"], ["type", "button", 1, "flex", "flex-col", "items-center", "justify-center", "gap-1", "flex-1", "h-full", "py-2", "px-1", "transition-colors", "duration-200", "appearance-none", "bg-transparent", "border-none", "cursor-pointer", 3, "text-indigo-600", "dark:text-purple-400", "text-stone-500", "dark:text-slate-400"], ["type", "button", 1, "flex", "flex-col", "items-center", "justify-center", "gap-1", "flex-1", "h-full", "py-2", "px-1", "transition-colors", "duration-200", "appearance-none", "bg-transparent", "border-none", "cursor-pointer", 3, "click"], ["aria-hidden", "true", 1, "text-2xl", 3, "name"], [1, "text-xs", "font-semibold", "leading-none"]], template: function BottomNavComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275repeaterCreate(2, BottomNavComponent_For_3_Template, 4, 12, "button", 2, _forTrack03);
        \u0275\u0275elementEnd()();
      }
      if (rf & 2) {
        \u0275\u0275advance(2);
...
function AddEditChildModalComponent_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(16, AddEditChildModalComponent_Conditional_14_For_17_Template, 2, 3, "button", 36, _forTrack04);
    \u0275\u0275elementEnd();
...
function AddEditChildModalComponent_Conditional_16_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, AddEditChildModalComponent_Conditional_16_Conditional_14_For_2_Template, 9, 2, "div", 62, _forTrack1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function OfflineIndicatorComponent_Conditional_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("size", 16);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ctx_r0.offlineService.hasPendingSync() ? ctx_r0.offlineText.pendingSync : ctx_r0.offlineText.offline, " ");
    \u0275\u0275advance();
...
function ShellComponent_Conditional_10_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ShellComponent_Conditional_10_Conditional_0_Template_button_click_7_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.isAddingChild.set(true));
    });
    \u0275\u0275element(8, "lucide-icon", 19);
    \u0275\u0275text(9);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function ShellComponent_Conditional_10_Conditional_1_For_7_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 35);
    \u0275\u0275element(1, "lucide-icon", 38);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function ShellComponent_Conditional_10_Conditional_1_For_7_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 23)(1, "button", 28);
    \u0275\u0275listener("click", function ShellComponent_Conditional_10_Conditional_1_For_7_Template_button_click_1_listener() {
    ...
    \u0275\u0275listener("click", function ShellComponent_Conditional_10_Conditional_1_For_7_Template_div_click_3_listener() {
      const child_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r0 = \u0275\u0275nextContext(3);
    ...
    \u0275\u0275element(5, "img", 32);
    \u0275\u0275elementStart(6, "div")(7, "h3", 33);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "p", 34);
    \u0275\u0275text(10);
    \u0275\u0275elementEnd()()();
    \u0275\u0275conditionalCreate(11, ShellComponent_Conditional_10_Conditional_1_For_7_Conditional_11_Template, 3, 1, "div", 35);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "div", 36);
    \u0275\u0275listener("click", function ShellComponent_Conditional_10_Conditional_1_For_7_Template_div_click_12_listener() {
      const child_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r0 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r0.selectChild(child_r5.id));
    });
...
function ShellComponent_Conditional_10_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 13)(1, "h2", 20);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275repeaterCreate(6, ShellComponent_Conditional_10_Conditional_1_For_7_Template, 15, 6, "div", 23, _forTrack05);
...
function ShellComponent_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, ShellComponent_Conditional_10_Conditional_0_Template, 10, 4, "div", 12)(1, ShellComponent_Conditional_10_Conditional_1_Template, 13, 3, "div", 13);
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
function ShellComponent_Conditional_11_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
...
function ShellComponent_Conditional_11_Conditional_45_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "lucide-icon", 61);
  }
}
function ShellComponent_Conditional_11_Conditional_71_Template(rf, ctx) {
  if (rf & 1) {
...
function ShellComponent_Conditional_11_Conditional_72_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 70);
    \u0275\u0275element(1, "lucide-icon", 77);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function ShellComponent_Conditional_11_Conditional_73_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div")(1, "label", 42);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "input", 78);
    \u0275\u0275twoWayListener("ngModelChange", function ShellComponent_Conditional_11_Conditional_73_Template_input_ngModelChange_3_listener($event) {
      \u0275\u0275restoreView(_r7);
      const ctx_r0 = \u0275\u0275nextContext(2);
...
function ShellComponent_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 7)(1, "h2", 39);
    \u0275\u0275element(2, "lucide-icon", 40);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 41)(5, "div")(6, "label", 42);
    \u0275\u0275text(7);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "input", 43);
    \u0275\u0275twoWayListener("ngModelChange", function ShellComponent_Conditional_11_Template_input_ngModelChange_8_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r0 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r0.newChildName, $event) || (ctx_r0.newChildName = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("input", function ShellComponent_Conditional_11_Template_input_input_8_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.onAddNameInput($event));
    })("blur", function ShellComponent_Conditional_11_Template_input_blur_8_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.onAddNameBlur());
    });
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(9, ShellComponent_Conditional_11_Conditional_9_Template, 3, 1, "p", 44);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "div")(11, "label", 42);
    \u0275\u0275text(12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "div", 45)(14, "input", 46);
    \u0275\u0275twoWayListener("ngModelChange", function ShellComponent_Conditional_11_Template_input_ngModelChange_14_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r0 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r0.newChildDob, $event) || (ctx_r0.newChildDob = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("input", function ShellComponent_Conditional_11_Template_input_input_14_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r0 = \u0275\u0275nextContext();
    ...
    \u0275\u0275element(16, "lucide-icon", 48);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(17, "div", 49)(18, "div")(19, "label", 42);
    \u0275\u0275text(20);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(21, "input", 50);
    \u0275\u0275twoWayListener("ngModelChange", function ShellComponent_Conditional_11_Template_input_ngModelChange_21_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r0 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(24);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "div", 45)(26, "select", 51);
    \u0275\u0275twoWayListener("ngModelChange", function ShellComponent_Conditional_11_Template_select_ngModelChange_26_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r0 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(30, "A+");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(31, "option", 54);
    \u0275\u0275text(32, "A-");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(33, "option", 55);
    \u0275\u0275text(34, "B+");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(35, "option", 56);
    \u0275\u0275text(36, "B-");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(37, "option", 57);
    \u0275\u0275text(38, "AB+");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(39, "option", 58);
    \u0275\u0275text(40, "AB-");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(41, "option", 59);
    \u0275\u0275text(42, "O+");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(43, "option", 60);
    \u0275\u0275text(44, "O-");
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(45, ShellComponent_Conditional_11_Conditional_45_Template, 1, 0, "lucide-icon", 61);
    \u0275\u0275element(46, "lucide-icon", 62);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(47, "div")(48, "label", 42);
    \u0275\u0275text(49);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(50, "div", 45)(51, "select", 63);
    \u0275\u0275twoWayListener("ngModelChange", function ShellComponent_Conditional_11_Template_select_ngModelChange_51_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r0 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r0.newChildGender, $event) || (ctx_r0.newChildGender = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementStart(52, "option", 52);
    \u0275\u0275text(53, "--");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(54, "option", 64);
    \u0275\u0275text(55);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(56, "option", 65);
    \u0275\u0275text(57);
    \u0275\u0275elementEnd()();
    \u0275\u0275element(58, "lucide-icon", 62);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(59, "div")(60, "label", 42);
    \u0275\u0275text(61);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(62, "textarea", 66);
    \u0275\u0275twoWayListener("ngModelChange", function ShellComponent_Conditional_11_Template_textarea_ngModelChange_62_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r0 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(63, "div")(64, "label", 42);
    \u0275\u0275text(65);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(66, "textarea", 67);
    \u0275\u0275twoWayListener("ngModelChange", function ShellComponent_Conditional_11_Template_textarea_ngModelChange_66_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r0 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(67, "div")(68, "label", 42);
    \u0275\u0275text(69);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(70, "input", 68);
    \u0275\u0275listener("change", function ShellComponent_Conditional_11_Template_input_change_70_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.onNewChildDocumentSelected($event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(71, ShellComponent_Conditional_11_Conditional_71_Template, 2, 1, "p", 69);
    \u0275\u0275conditionalCreate(72, ShellComponent_Conditional_11_Conditional_72_Template, 3, 1, "p", 70);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(73, ShellComponent_Conditional_11_Conditional_73_Template, 4, 2, "div");
    \u0275\u0275elementStart(74, "div")(75, "label", 42);
    \u0275\u0275text(76);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(77, "input", 71);
    \u0275\u0275twoWayListener("ngModelChange", function ShellComponent_Conditional_11_Template_input_ngModelChange_77_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r0 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(78, "div", 72)(79, "button", 73);
    \u0275\u0275listener("click", function ShellComponent_Conditional_11_Template_button_click_79_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.submitNewChild());
    });
    \u0275\u0275element(80, "lucide-icon", 74);
    \u0275\u0275text(81);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(82, "button", 75);
    \u0275\u0275listener("click", function ShellComponent_Conditional_11_Template_button_click_82_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r0 = \u0275\u0275nextContext();
...
function ShellComponent_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 8)(1, "router-outlet", 79);
    \u0275\u0275listener("activate", function ShellComponent_Conditional_12_Template_router_outlet_activate_1_listener($event) {
      \u0275\u0275restoreView(_r8);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.onActivate($event));
    });
    \u0275\u0275elementEnd()();
  }
}
function ShellComponent_Conditional_15_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-export-modal", 80);
    \u0275\u0275listener("closed", function ShellComponent_Conditional_15_Template_app_export_modal_closed_0_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.showExportModal.set(false));
    });
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275property("childId", ctx_r0.dataService.activeChildId())("isOpen", ctx_r0.showExportModal());
  }
}
function ShellComponent_Conditional_16_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-add-edit-child-modal", 81);
    \u0275\u0275listener("saved", function ShellComponent_Conditional_16_Template_app_add_edit_child_modal_saved_0_listener($event) {
      \u0275\u0275restoreView(_r10);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.onChildSaved($event));
    })("cancelled", function ShellComponent_Conditional_16_Template_app_add_edit_child_modal_cancelled_0_listener() {
      \u0275\u0275restoreView(_r10);
      const ctx_r0 = \u0275\u0275nextContext();
...
function ShellComponent_Conditional_17_Conditional_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "lucide-icon", 94);
  }
}
function ShellComponent_Conditional_17_Conditional_18_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 44);
    \u0275\u0275element(1, "lucide-icon", 76);
    \u0275\u0275text(2);
...
function ShellComponent_Conditional_17_Conditional_49_Template(rf, ctx) {
  if (rf & 1) {
...
function ShellComponent_Conditional_17_Conditional_51_Template(rf, ctx) {
  if (rf & 1) {
...
function ShellComponent_Conditional_17_Conditional_84_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 69);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function ShellComponent_Conditional_17_Conditional_85_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 70);
    \u0275\u0275element(1, "lucide-icon", 77);
    \u0275\u0275text(2);
...
function ShellComponent_Conditional_17_Conditional_86_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "input", 78);
    \u0275\u0275twoWayListener("ngModelChange", function ShellComponent_Conditional_17_Conditional_86_Template_input_ngModelChange_3_listener($event) {
      \u0275\u0275restoreView(_r12);
      const ctx_r0 = \u0275\u0275nextContext(2);
...
function ShellComponent_Conditional_17_Conditional_88_Template(rf, ctx) {
  if (rf & 1) {
...
function ShellComponent_Conditional_17_Conditional_90_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "lucide-icon", 108);
    \u0275\u0275elementStart(1, "span");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
  }
...
function ShellComponent_Conditional_17_Conditional_91_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "lucide-icon", 74);
    \u0275\u0275text(1);
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
...
function ShellComponent_Conditional_17_Conditional_95_Template(rf, ctx) {
  if (rf & 1) {
    const _r13 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 107)(1, "div", 109)(2, "div", 110);
    \u0275\u0275element(3, "lucide-icon", 111);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div")(5, "p", 112);
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function ShellComponent_Conditional_17_Conditional_95_Template_button_click_12_listener() {
      \u0275\u0275restoreView(_r13);
      const ctx_r0 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275text(13);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "button", 117);
    \u0275\u0275listener("click", function ShellComponent_Conditional_17_Conditional_95_Template_button_click_14_listener() {
      \u0275\u0275restoreView(_r13);
      const ctx_r0 = \u0275\u0275nextContext(2);
...
function ShellComponent_Conditional_17_Template(rf, ctx) {
  if (rf & 1) {
    const _r11 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 11)(1, "div", 82);
    \u0275\u0275listener("click", function ShellComponent_Conditional_17_Template_div_click_1_listener() {
      \u0275\u0275restoreView(_r11);
      const ctx_r0 = \u0275\u0275nextContext();
    ...
    \u0275\u0275element(3, "div", 84);
    \u0275\u0275elementStart(4, "div", 85)(5, "div", 86)(6, "h2", 87);
    \u0275\u0275element(7, "lucide-icon", 88);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "button", 89);
    \u0275\u0275listener("click", function ShellComponent_Conditional_17_Template_button_click_9_listener() {
      \u0275\u0275restoreView(_r11);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.closeEditModal());
    });
    \u0275\u0275element(10, "lucide-icon", 90);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(11, "div", 91)(12, "div")(13, "label", 92);
    \u0275\u0275text(14);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "div", 45)(16, "input", 93);
    \u0275\u0275twoWayListener("ngModelChange", function ShellComponent_Conditional_17_Template_input_ngModelChange_16_listener($event) {
      \u0275\u0275restoreView(_r11);
      const ctx_r0 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r0.editName, $event) || (ctx_r0.editName = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("input", function ShellComponent_Conditional_17_Template_input_input_16_listener($event) {
      \u0275\u0275restoreView(_r11);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.onEditNameInput($event));
    })("blur", function ShellComponent_Conditional_17_Template_input_blur_16_listener() {
      \u0275\u0275restoreView(_r11);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.onEditNameBlur());
    });
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(17, ShellComponent_Conditional_17_Conditional_17_Template, 1, 0, "lucide-icon", 94);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(18, ShellComponent_Conditional_17_Conditional_18_Template, 3, 1, "p", 44);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "div")(20, "label", 92);
    \u0275\u0275text(21);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(22, "div", 45)(23, "input", 95);
    \u0275\u0275twoWayListener("ngModelChange", function ShellComponent_Conditional_17_Template_input_ngModelChange_23_listener($event) {
      \u0275\u0275restoreView(_r11);
      const ctx_r0 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r0.editDob, $event) || (ctx_r0.editDob = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("input", function ShellComponent_Conditional_17_Template_input_input_23_listener($event) {
      \u0275\u0275restoreView(_r11);
      const ctx_r0 = \u0275\u0275nextContext();
    ...
    \u0275\u0275element(25, "lucide-icon", 48);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(26, "div")(27, "label", 92);
    \u0275\u0275text(28);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(29, "div", 45)(30, "select", 96);
    \u0275\u0275listener("ngModelChange", function ShellComponent_Conditional_17_Template_select_ngModelChange_30_listener($event) {
      \u0275\u0275restoreView(_r11);
      const ctx_r0 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(34, "A+");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(35, "option", 54);
    \u0275\u0275text(36, "A-");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(37, "option", 55);
    \u0275\u0275text(38, "B+");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(39, "option", 56);
    \u0275\u0275text(40, "B-");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(41, "option", 57);
    \u0275\u0275text(42, "AB+");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(43, "option", 58);
    \u0275\u0275text(44, "AB-");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(45, "option", 59);
    \u0275\u0275text(46, "O+");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(47, "option", 60);
    \u0275\u0275text(48, "O-");
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(49, ShellComponent_Conditional_17_Conditional_49_Template, 2, 0, "span", 97);
    \u0275\u0275element(50, "lucide-icon", 62);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(51, ShellComponent_Conditional_17_Conditional_51_Template, 3, 1, "p", 98);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(52, "div")(53, "label", 92);
    \u0275\u0275text(54);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(55, "div", 45)(56, "select", 99);
    \u0275\u0275twoWayListener("ngModelChange", function ShellComponent_Conditional_17_Template_select_ngModelChange_56_listener($event) {
      \u0275\u0275restoreView(_r11);
      const ctx_r0 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r0.editGender, $event) || (ctx_r0.editGender = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementStart(57, "option", 52);
    \u0275\u0275text(58, "--");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(59, "option", 64);
    \u0275\u0275text(60);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(61, "option", 65);
    \u0275\u0275text(62);
    \u0275\u0275elementEnd()();
    \u0275\u0275element(63, "lucide-icon", 62);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(64, "div")(65, "label", 92);
    \u0275\u0275text(66);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(67, "input", 100);
    \u0275\u0275twoWayListener("ngModelChange", function ShellComponent_Conditional_17_Template_input_ngModelChange_67_listener($event) {
      \u0275\u0275restoreView(_r11);
      const ctx_r0 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(68, "div")(69, "label", 92);
    \u0275\u0275text(70);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(71, "input", 101);
    \u0275\u0275twoWayListener("ngModelChange", function ShellComponent_Conditional_17_Template_input_ngModelChange_71_listener($event) {
      \u0275\u0275restoreView(_r11);
      const ctx_r0 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(72, "div")(73, "label", 42);
    \u0275\u0275text(74);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(75, "textarea", 66);
    \u0275\u0275twoWayListener("ngModelChange", function ShellComponent_Conditional_17_Template_textarea_ngModelChange_75_listener($event) {
      \u0275\u0275restoreView(_r11);
      const ctx_r0 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(78);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(79, "textarea", 67);
    \u0275\u0275twoWayListener("ngModelChange", function ShellComponent_Conditional_17_Template_textarea_ngModelChange_79_listener($event) {
      \u0275\u0275restoreView(_r11);
      const ctx_r0 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(80, "div")(81, "label", 42);
    \u0275\u0275text(82);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(83, "input", 68);
    \u0275\u0275listener("change", function ShellComponent_Conditional_17_Template_input_change_83_listener($event) {
      \u0275\u0275restoreView(_r11);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.onDocumentSelected($event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(84, ShellComponent_Conditional_17_Conditional_84_Template, 2, 1, "p", 69);
    \u0275\u0275conditionalCreate(85, ShellComponent_Conditional_17_Conditional_85_Template, 3, 1, "p", 70);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(86, ShellComponent_Conditional_17_Conditional_86_Template, 4, 2, "div");
    \u0275\u0275elementStart(87, "div", 102);
    \u0275\u0275conditionalCreate(88, ShellComponent_Conditional_17_Conditional_88_Template, 3, 1, "div", 103);
    \u0275\u0275elementStart(89, "button", 104);
    \u0275\u0275listener("click", function ShellComponent_Conditional_17_Template_button_click_89_listener() {
      \u0275\u0275restoreView(_r11);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.saveEditChild());
    });
    \u0275\u0275conditionalCreate(90, ShellComponent_Conditional_17_Conditional_90_Template, 3, 1)(91, ShellComponent_Conditional_17_Conditional_91_Template, 2, 1);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(92, "button", 105);
    \u0275\u0275listener("click", function ShellComponent_Conditional_17_Template_button_click_92_listener() {
      \u0275\u0275restoreView(_r11);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.showDeleteConfirm.set(true));
    });
    \u0275\u0275element(93, "lucide-icon", 106);
    \u0275\u0275text(94);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(95, ShellComponent_Conditional_17_Conditional_95_Template, 17, 5, "div", 107);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    ...
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ShellComponent, selectors: [["app-shell"]], decls: 18, vars: 12, consts: [[1, "h-screen", "flex", "bg-background", "overflow-hidden", "relative", "font-sans"], [1, "hidden", "lg:block"], ["id", "main-content", 1, "flex-1", "flex", "flex-col", "h-screen", "overflow-hidden", "relative", "z-10", "w-full"], ["href", "#main-content", 1, "sr-only", "focus:not-sr-only", "focus:absolute", "focus:top-2", "focus:left-2", "focus:z-50", "focus:px-4", "focus:py-2", "focus:bg-primary-600", "focus:text-white", "focus:rounded-lg"], [3, "childSwitchRequested", "addChildRequested", "switchProfileRequested", "backRequested", "localeToggleRequested", "exportRequested", "currentTab", "viewState", "switching"], ["aria-live", "polite", "aria-atomic", "true", 1, "sr-only"], [1, "flex-1", "overflow-y-auto", "w-full", "px-4", "pt-6", "pb-24", "lg:px-12", "lg:py-10", "bg-slate-50/50", "relative"], [1, "glass", "max-w-3xl", "mx-auto", "rounded-[2rem]", "p-10", "lg:p-14", "animate-slide-up", "shadow-[0_20px_60px_-15px_rgba(0,0,0,0.05)]", "border", "border-white"], [1, "animate-fade-in", "h-full"], [3, "childId", "isOpen"], [3, "mode", "child"], ["role", "dialog", "aria-modal", "true", 1, "fixed", "inset-0", "z-50", "flex", "items-center", "justify-center", "p-4"], [1, "h-full", "flex", "flex-col", "items-center", "justify-center", "text-center", "animate-slide-up", "max-w-lg", "mx-auto"], [1, "animate-slide-up"], [1, "w-40", "h-40", "bg-gradient-to-tr", "from-primary-100", "to-teal-50", "text-primary-500", "rounded-full", "flex", "items-center", "justify-center", "mb-10", "shadow-glass", "border", "border-white"], ["name", "party-popper", 1, "opacity-80", 3, "size"], [1, "text-3xl", "lg:text-4xl", "font-extrabold", "text-gray-800", "mb-4", "tracking-tight"], [1, "text-gray-500", "text-lg", "mb-10", "leading-relaxed"], [1, "bg-slate-900", "hover:bg-primary-600", "text-white", "px-10", "py-5", "rounded-2xl", "font-bold", "shadow-[0_10px_20px_rgba(0,0,0,0.1)]", "transition-all", "transform", "hover:-translate-y-1", "flex", "items-center", "gap-3", "text-lg", "w-full", "sm:w-auto", "justify-center", 3, "click"], ["name", "plus", "aria-hidden", "true", 1, "bg-white/20", "rounded-full", "p-1"], [1, "text-3xl", "font-extrabold", "text-gray-800", "mb-2", "tracking-tight"], [1, "text-gray-500", "text-sm", "mb-10", "font-medium", "leading-relaxed"], [1, "grid", "grid-cols-1", "sm:grid-cols-2", "lg:grid-cols-3", "gap-6"], [1, "bg-white", "rounded-[2rem]", "p-8", "shadow-md", "border", "border-slate-100", "hover:shadow-xl", "hover:border-primary-200", "transition-all", "group", "relative", "card-hover"], ["type", "button", 1, "bg-slate-50", "rounded-[2rem]", "p-8", "shadow-md", "border-2", "border-dashed", "border-slate-200", "hover:border-primary-300", "hover:bg-primary-50", "transition-all", "cursor-pointer", "flex", "flex-col", "items-center", "justify-center", "gap-4", "text-center", "group", "w-full", "text-left", 3, "click"], [1, "w-16", "h-16", "rounded-full", "bg-slate-100", "group-hover:bg-primary-100", "flex", "items-center", "justify-center", "transition-all"], ["name", "plus", "aria-hidden", "true", 1, "text-3xl", "text-slate-400", "group-hover:text-primary-500", "transition-colors"], [1, "font-bold", "text-slate-500", "group-hover:text-primary-600", "transition-colors", "text-base"], [1, "absolute", "top-5", "right-5", "w-9", "h-9", "rounded-xl", "bg-slate-50", "hover:bg-primary-50", "border", "border-slate-200", "hover:border-primary-300", "flex", "items-center", "justify-center", "text-slate-400", "hover:text-primary-600", "transition-all", "shadow-sm", 3, "click"], ["name", "pencil", "aria-hidden", "true", 1, "text-base"], [1, "cursor-pointer", 3, "click"], [1, "flex", "items-center", "gap-5", "mb-5"], [1, "w-16", "h-16", "rounded-full", "border-4", "border-slate-100", "group-hover:border-primary-200", "transition-all", "shadow-sm", 3, "src"], [1, "font-extrabold", "text-xl", "text-gray-800", "group-hover:text-primary-700", "transition-colors"], [1, "text-sm", "text-gray-500", "font-medium"], [1, "flex", "items-center", "gap-2", "text-sm", "text-gray-500", "font-medium"], [1, "mt-5", "bg-gradient-to-r", "from-primary-50", "to-teal-50", "rounded-2xl", "p-4", "flex", "items-center", "justify-center", "gap-2", "text-primary-600", "font-bold", "group-hover:from-primary-100", "group-hover:to-teal-100", "transition-all", "cursor-pointer", 3, "click"], ["name", "log-in", 1, "text-lg"], ["name", "droplet", 1, "text-teal-500", "text-base"], [1, "text-3xl", "font-extrabold", "text-gray-800", "mb-10", "flex", "items-center", "gap-4"], ["name", "user-plus", "aria-hidden", "true", 1, "text-primary-500", "bg-primary-50", "p-3", "rounded-2xl"], [1, "space-y-8"], [1, "block", "text-sm", "font-bold", "text-primary-700", "mb-3", "ml-1", "tracking-wide", "uppercase", "text-xs"], ["type", "text", 1, "w-full", "px-5", "py-4.5", "rounded-2xl", "bg-white", "border-2", "transition-all", "text-lg", "text-gray-800", "placeholder-gray-300", 3, "ngModelChange", "input", "blur", "ngModel", "ngClass", "placeholder"], [1, "mt-2", "text-sm", "text-red-500", "font-medium", "flex", "items-center", "gap-1"], [1, "relative"], ["type", "text", "maxlength", "10", 1, "w-full", "px-5", "py-4.5", "pr-12", "rounded-2xl", "bg-white", "border-2", "border-slate-200", "focus:bg-white", "focus:ring-4", "focus:ring-primary-500/10", "focus:border-primary-500", "outline-none", "transition-all", "text-lg", "text-gray-600", "placeholder-gray-300", 3, "ngModelChange", "input", "ngModel", "placeholder"], ["type", "button", "onclick", "this.previousElementSibling.showPicker?.()", 1, "absolute", "right-3", "top-1/2", "-translate-y-1/2", "w-8", "h-8", "flex", "items-center", "justify-center", "rounded-xl", "text-slate-400", "hover:text-primary-500", "hover:bg-primary-50", "transition-all", "cursor-pointer"], ["name", "calendar", 1, "text-inherit"], [1, "grid", "grid-cols-1", "sm:grid-cols-2", "gap-6"], ["type", "number", "step", "0.01", 1, "w-full", "px-5", "py-4.5", "rounded-2xl", "bg-white", "border-2", "border-slate-200", "focus:bg-white", "focus:ring-4", "focus:ring-primary-500/10", "focus:border-primary-500", "outline-none", "transition-all", "text-lg", "text-gray-600", "shadow-sm", "placeholder-gray-300", 3, "ngModelChange", "ngModel", "placeholder"], [1, "w-full", "px-5", "py-4.5", "rounded-2xl", "bg-white", "border-2", "transition-all", "text-lg", "shadow-sm", "appearance-none", 3, "ngModelChange", "ngModel", "ngClass"], ["value", ""], ["value", "A+"], ["value", "A-"], ["value", "B+"], ["value", "B-"], ["value", "AB+"], ["value", "AB-"], ["value", "O+"], ["value", "O-"], ["name", "badge-check", 1, "text-inherit"], ["name", "chevron-down", 1, "text-inherit"], [1, "w-full", "px-5", "py-4.5", "rounded-2xl", "bg-white", "border-2", "border-slate-200", "transition-all", "text-lg", "shadow-sm", "appearance-none", "focus:bg-white", "focus:ring-4", "focus:ring-primary-500/10", "focus:border-primary-500", 3, "ngModelChange", "ngModel"], ["value", "M"], ["value", "F"], ["rows", "2", 1, "w-full", "px-5", "py-4", "rounded-2xl", "bg-white", "border-2", "border-slate-200", "focus:ring-4", "focus:ring-primary-500/10", "focus:border-primary-500", "outline-none", "transition-all", "text-lg", "text-gray-800", "shadow-sm", "placeholder-gray-300", "resize-none", 3, "ngModelChange", "ngModel", "placeholder"], ["rows", "3", 1, "w-full", "px-5", "py-4", "rounded-2xl", "bg-white", "border-2", "border-slate-200", "focus:ring-4", "focus:ring-primary-500/10", "focus:border-primary-500", "outline-none", "transition-all", "text-lg", "text-gray-800", "shadow-sm", "placeholder-gray-300", "resize-none", 3, "ngModelChange", "ngModel", "placeholder"], ["type", "file", "accept", ".pdf,image/*", 1, "w-full", "file:mr-4", "file:px-4", "file:py-2", "file:rounded-xl", "file:border-0", "file:bg-primary-50", "file:text-primary-700", "file:font-bold", "file:cursor-pointer", "text-sm", "text-gray-500", "cursor-pointer", 3, "change"], [1, "text-red-500", "text-xs", "mt-1"], [1, "text-teal-600", "text-xs", "mt-1", "flex", "items-center", "gap-1"], ["type", "text", 1, "w-full", "px-5", "py-4.5", "rounded-2xl", "bg-white", "border-2", "border-slate-200", "focus:bg-white", "focus:ring-4", "focus:ring-primary-500/10", "focus:border-primary-500", "outline-none", "transition-all", "text-lg", "text-gray-800", "shadow-sm", "placeholder-gray-300", 3, "ngModelChange", "ngModel", "placeholder"], [1, "flex", "flex-col", "sm:flex-row", "gap-4", "pt-6", "border-t", "border-gray-100", "mt-4"], ["type", "button", 1, "flex-1", "bg-gradient-to-r", "from-primary-600", "to-primary-500", "hover:from-primary-500", "hover:to-primary-400", "text-white", "py-4.5", "rounded-2xl", "font-bold", "hover:shadow-lg", "hover:-translate-y-0.5", "transition-all", "flex", "items-center", "justify-center", "gap-2", "text-lg", "shadow-md", 3, "click", "disabled"], ["name", "save", "aria-hidden", "true", 1, "text-inherit"], ["type", "button", 1, "px-8", "py-4.5", "bg-slate-100", "text-slate-600", "font-bold", "rounded-2xl", "hover:bg-slate-200", "transition-colors", "text-lg", "hover:-translate-y-0.5", 3, "click"], ["name", "alert-circle", 1, "text-inherit"], ["name", "check-circle", 1, "text-inherit"], ["type", "date", 1, "w-full", "px-5", "py-4", "rounded-2xl", "bg-white", "border-2", "border-slate-200", "focus:ring-4", "focus:ring-primary-500/10", "focus:border-primary-500", "outline-none", "transition-all", "text-lg", "text-gray-600", "shadow-sm", 3, "ngModelChange", "ngModel"], [3, "activate"], [3, "closed", "childId", "isOpen"], [3, "saved", "cancelled", "mode", "child"], ["aria-hidden", "true", 1, "absolute", "inset-0", "bg-black/40", "backdrop-blur-sm", 3, "click"], [1, "relative", "z-10", "w-full", "max-w-md", "bg-white", "rounded-[2rem]", "shadow-[0_32px_80px_-12px_rgba(0,0,0,0.25)]", "border", "border-slate-100", "overflow-hidden", "animate-slide-up"], [1, "h-1.5", "bg-gradient-to-r", "from-primary-600", "via-primary-500", "to-teal-400"], [1, "p-10"], [1, "flex", "items-center", "justify-between", "mb-8"], ["id", "edit-child-title", 1, "text-2xl", "font-black", "text-gray-800", "flex", "items-center", "gap-3"], ["name", "pencil", "aria-hidden", "true", 1, "text-inherit"], ["type", "button", 1, "w-9", "h-9", "rounded-xl", "bg-slate-50", "hover:bg-slate-100", "flex", "items-center", "justify-center", "text-slate-400", "hover:text-slate-600", "transition-all", "shadow-sm", "border", "border-slate-200", 3, "click", "aria-label"], ["name", "x", "aria-hidden", "true", 1, "text-inherit"], [1, "space-y-6"], [1, "block", "text-xs", "font-bold", "text-primary-700", "mb-2.5", "ml-1", "uppercase", "tracking-wider"], ["type", "text", 1, "w-full", "px-5", "py-4", "rounded-2xl", "bg-slate-50", "border-2", "transition-all", "text-lg", "text-gray-800", "pr-10", 3, "ngModelChange", "input", "blur", "ngModel", "ngClass"], ["name", "alert-circle", 1, "absolute", "right-3", "top-1/2", "-translate-y-1/2", "text-red-400", "text-xl", "animate-fade-in"], ["type", "text", "maxlength", "10", 1, "w-full", "px-5", "py-4", "pr-12", "rounded-2xl", "bg-slate-50", "border-2", "border-slate-200", "focus:bg-white", "focus:ring-4", "focus:ring-primary-500/10", "focus:border-primary-500", "outline-none", "transition-all", "text-lg", "text-gray-600", "placeholder-gray-300", 3, "ngModelChange", "input", "ngModel", "placeholder"], [1, "w-full", "px-5", "py-4", "rounded-2xl", "bg-slate-50", "border-2", "transition-all", "text-lg", "shadow-sm", "appearance-none", 3, "ngModelChange", "ngModel", "ngClass"], [1, "absolute", "right-12", "top-1/2", "-translate-y-1/2", "flex", "items-center", "gap-1", "animate-fade-in"], [1, "mt-2", "text-xs", "text-teal-600", "font-medium", "flex", "items-center", "gap-1", "animate-fade-in"], [1, "w-full", "px-5", "py-4", "rounded-2xl", "bg-slate-50", "border-2", "border-slate-200", "transition-all", "text-lg", "shadow-sm", "appearance-none", "focus:bg-white", "focus:ring-4", "focus:ring-primary-500/10", "focus:border-primary-500", 3, "ngModelChange", "ngModel"], ["type", "number", "step", "0.01", 1, "w-full", "px-5", "py-4", "rounded-2xl", "bg-slate-50", "border-2", "border-slate-200", "focus:bg-white", "focus:ring-4", "focus:ring-primary-500/10", "focus:border-primary-500", "outline-none", "transition-all", "text-lg", "text-gray-800", "shadow-sm", "placeholder-gray-300", 3, "ngModelChange", "ngModel", "placeholder"], ["type", "text", 1, "w-full", "px-5", "py-4", "rounded-2xl", "bg-slate-50", "border-2", "border-slate-200", "focus:bg-white", "focus:ring-4", "focus:ring-primary-500/10", "focus:border-primary-500", "outline-none", "transition-all", "text-lg", "text-gray-800", "shadow-sm", "placeholder-gray-300", 3, "ngModelChange", "ngModel", "placeholder"], [1, "flex", "flex-col", "gap-3", "pt-4", "border-t", "border-gray-100"], [1, "flex", "items-center", "gap-2", "p-3", "bg-teal-50", "border", "border-teal-200", "rounded-xl", "text-teal-700", "text-sm", "font-medium", "animate-fade-in"], ["type", "button", 1, "w-full", "bg-gradient-to-r", "from-primary-600", "to-primary-500", "hover:from-primary-500", "hover:to-primary-400", "text-white", "py-4", "rounded-2xl", "font-bold", "hover:shadow-lg", "hover:-translate-y-0.5", "transition-all", "flex", "items-center", "justify-center", "gap-2", "text-base", "shadow-md", "disabled:opacity-50", "disabled:cursor-not-allowed", "disabled:transform-none", 3, "click", "disabled"], ["type", "button", 1, "w-full", "border-2", "border-red-200", "text-red-500", "hover:bg-red-50", "hover:border-red-300", "py-3.5", "rounded-2xl", "font-bold", "transition-all", "flex", "items-center", "justify-center", "gap-2", "text-sm", 3, "click"], ["name", "trash-2", "aria-hidden", "true", 1, "text-inherit"], [1, "mt-4", "p-5", "bg-red-50", "border-2", "border-red-200", "rounded-2xl", "animate-fade-in"], ["name", "loader", "aria-hidden", "true", 1, "text-inherit"], [1, "flex", "items-center", "gap-3", "mb-3"], [1, "w-10", "h-10", "bg-red-100", "rounded-full", "flex", "items-center", "justify-center"], ["name", "alert-triangle", 1, "text-inherit"], [1, "font-bold", "text-gray-800", "text-base"], [1, "text-sm", "text-gray-500"], [1, "text-sm", "text-gray-600", "mb-5"], [1, "flex", "gap-3"], ["type", "button", 1, "flex-1", "py-3", "rounded-xl", "border-2", "border-slate-200", "text-gray-600", "font-bold", "hover:bg-slate-100", "transition-all", "text-sm", 3, "click"], ["type", "button", 1, "flex-1", "py-3", "rounded-xl", "bg-gradient-to-r", "from-red-500", "to-red-400", "text-white", "font-bold", "hover:from-red-400", "hover:to-red-300", "transition-all", "text-sm", "shadow-sm", "flex", "items-center", "justify-center", "gap-2", 3, "click"], ["name", "trash", "aria-hidden", "true", 1, "text-inherit"]], template: function ShellComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275listener("childSwitchRequested", function ShellComponent_Template_app_header_childSwitchRequested_5_listener($event) {
          ...
          return ctx.i18n.toggleLocale();
        })("exportRequested", function ShellComponent_Template_app_header_exportRequested_5_listener() {
        ...
        \u0275\u0275elementEnd();
        \u0275\u0275element(8, "app-offline-indicator");
        \u0275\u0275elementStart(9, "div", 6);
        \u0275\u0275conditionalCreate(10, ShellComponent_Conditional_10_Template, 2, 1)(11, ShellComponent_Conditional_11_Template, 84, 37, "div", 7)(12, ShellComponent_Conditional_12_Template, 2, 0, "div", 8);
        \u0275\u0275elementEnd()();
        \u0275\u0275element(13, "app-onboarding-tour")(14, "app-bottom-nav");
        \u0275\u0275conditionalCreate(15, ShellComponent_Conditional_15_Template, 1, 2, "app-export-modal", 9);
        \u0275\u0275conditionalCreate(16, ShellComponent_Conditional_16_Template, 1, 2, "app-add-edit-child-modal", 10);
        \u0275\u0275conditionalCreate(17, ShellComponent_Conditional_17_Template, 96, 43, "div", 11);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275advance(5);
        ...
        \u0275\u0275advance();
        \u0275\u0275conditional(ctx.viewState() === "selector" ? 10 : ctx.isAddingChild() ? 11 : 12);
        \u0275\u0275advance(5);
        \u0275\u0275conditional(ctx.showExportModal() ? 15 : -1);
        \u0275\u0275advance();
        \u0275\u0275conditional(ctx.showChildModal() ? 16 : -1);
        \u0275\u0275advance();
        \u0275\u0275conditional(ctx.editingChild() ? 17 : -1);
      }
                ...
                @if (showDeleteConfirm()) {
                  <div class="mt-4 p-5 bg-red-50 border-2 border-red-200 rounded-2xl animate-fade-in">
                    <div class="flex items-center gap-3 mb-3">
                      ...
                      <div>
                        <p class="font-bold text-gray-800 text-base">{{ i18n.isSq() ? 'Fshi profilin e f\xEBmij\xEBs?' : 'Delete child profile?' }}</p>
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ShellComponent, { className: "ShellComponent", filePath: "src/app/components/shell.component.ts", lineNumber: 584 });
})();
...
var routes = [
  { path: "login", component: PinLockComponent },
  {
    ...
    children: [
      ...
      { path: "home", loadComponent: () => import("./chunk-B6T6BQQQ.js").then((m) => m.HomeComponent) },
      { path: "diary", loadComponent: () => import("./chunk-A3DXW2GR.js").then((m) => m.DiaryComponent) },
      { path: "temperature", loadComponent: () => import("./chunk-X4JZATPC.js").then((m) => m.TemperatureDiaryComponent) },
      { path: "growth", loadComponent: () => import("./chunk-S73ZA4S5.js").then((m) => m.GrowthTrackingComponent) },
      { path: "records", loadComponent: () => import("./chunk-FYFJ23N4.js").then((m) => m.RecordsComponent) },
      { path: "vaccines", loadComponent: () => import("./chunk-V7Y355RI.js").then((m) => m.VaccinesComponent) },
      { path: "medications", loadComponent: () => import("./chunk-N2IKVKHZ.js").then((m) => m.MedicationsComponent) },
      { path: "appointments", loadComponent: () => import("./chunk-NUWECHWZ.js").then((m) => m.AppointmentsComponent) },
      { path: "lab-results", loadComponent: () => import("./chunk-TQOUU4AX.js").then((m) => m.LabResultsComponent) },
      { path: "analytics", loadComponent: () => import("./chunk-NSRMQPJF.js").then((m) => m.AnalyticsComponent) },
      { path: "settings", loadComponent: () => import("./chunk-FQVC4E4X.js").then((m) => m.SettingsPageComponent) }
    ]
  },
