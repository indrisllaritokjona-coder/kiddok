...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ShellComponent, { className: "ShellComponent", filePath: "src/app/components/shell.component.ts", lineNumber: 583 });
})();
...
var routes = [
  { path: "login", component: PinLockComponent },
  {
    ...
    children: [
      ...
      { path: "home", loadComponent: () => import("./chunk-4RSX4BSS.js").then((m) => m.HomeComponent) },
      { path: "diary", loadComponent: () => import("./chunk-57EGK64J.js").then((m) => m.DiaryComponent) },
      { path: "temperature", loadComponent: () => import("./chunk-JW2ILS7J.js").then((m) => m.TemperatureDiaryComponent) },
      { path: "growth", loadComponent: () => import("./chunk-3DAXOA5D.js").then((m) => m.GrowthTrackingComponent) },
      { path: "records", loadComponent: () => import("./chunk-HVDFK3KW.js").then((m) => m.RecordsComponent) },
      { path: "vaccines", loadComponent: () => import("./chunk-UNG2R7ZM.js").then((m) => m.VaccinesComponent) },
      { path: "medications", loadComponent: () => import("./chunk-VYPR24YF.js").then((m) => m.MedicationsComponent) },
      { path: "appointments", loadComponent: () => import("./chunk-TUUQGKCM.js").then((m) => m.AppointmentsComponent) },
      { path: "lab-results", loadComponent: () => import("./chunk-EQHCE3OI.js").then((m) => m.LabResultsComponent) },
      { path: "analytics", loadComponent: () => import("./chunk-CJDNQ7XZ.js").then((m) => m.AnalyticsComponent) },
      { path: "settings", loadComponent: () => import("./chunk-DVFA3AFZ.js").then((m) => m.SettingsPageComponent) }
    ]
  },
