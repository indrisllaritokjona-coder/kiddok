...
var routes = [
  { path: "login", component: PinLockComponent },
  {
    ...
    children: [
      ...
      { path: "home", loadComponent: () => import("./chunk-6S574JYL.js").then((m) => m.HomeComponent) },
      { path: "diary", loadComponent: () => import("./chunk-6KQDATAT.js").then((m) => m.DiaryComponent) },
      { path: "temperature", loadComponent: () => import("./chunk-AJQKSCAV.js").then((m) => m.TemperatureDiaryComponent) },
      { path: "growth", loadComponent: () => import("./chunk-7MBJN3ZL.js").then((m) => m.GrowthTrackingComponent) },
      { path: "records", loadComponent: () => import("./chunk-6KMLQASO.js").then((m) => m.RecordsComponent) },
      { path: "vaccines", loadComponent: () => import("./chunk-INACQGZR.js").then((m) => m.VaccinesComponent) },
      { path: "medications", loadComponent: () => import("./chunk-T7APJTW4.js").then((m) => m.MedicationsComponent) },
      { path: "appointments", loadComponent: () => import("./chunk-BHAZPAIC.js").then((m) => m.AppointmentsComponent) },
      { path: "lab-results", loadComponent: () => import("./chunk-YUGAGALH.js").then((m) => m.LabResultsComponent) },
      { path: "analytics", loadComponent: () => import("./chunk-CPUI2PH4.js").then((m) => m.AnalyticsComponent) },
      { path: "settings", loadComponent: () => import("./chunk-V5YY7SMX.js").then((m) => m.SettingsPageComponent) }
    ]
  },
