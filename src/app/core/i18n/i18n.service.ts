...
const translations = {
  ...
  'offline.retry': { sq: 'Provo përsëri', en: 'Retry' },
  'offline.pendingCount': { sq: '{n} në pritje', en: '{n} pending' },
  ...
  'sync.conflict.resolveLocal': { sq: 'Përdor Lokalen', en: 'Use Local' },
  'sync.conflict.resolveServer': { sq: 'Përdor Serverin', en: 'Use Server' },
  'sync.conflict.medicalReview': { sq: 'Rishikim Mjekësor', en: 'Medical Review' },
  'sync.conflict.footer': { sq: 'Konfliktet zgjidhen automatikisht për të dhëna jo-mjekësore.', en: 'Non-medical data conflicts are resolved automatically.' },
  'sync.conflict.panelTitle': { sq: 'Konflikt i të Dhënave', en: 'Data Conflict' },
  'sync.conflict.panelSubtitle': { sq: 'Të dhëna që kërkojnë rishikim manual', en: 'Data requiring manual review' },
  ...
  'sync.lastSynced.minsAgo': { sq: '{n} min më parë', en: '{n}m ago' },
  'sync.lastSynced.hoursAgo': { sq: '{n} orë më parë', en: '{n}h ago' },
  'sync.queue.count': { sq: '{n} në radhë', en: '{n} in queue' },
  'sync.online': { sq: 'Jeni online! Duke sinkronizuar...', en: 'You are online! Syncing...' },
  'sync.offline': { sq: 'Jeni offline. Të dhënat do të ruhen lokalisht.', en: 'You are offline. Data will be saved locally.' },
